...
webpackConfig.module.loaders.push(
  {
    ...
    exclude: /(node_modules|src\/views\/Home\/|src\/views\/GatherGoods\/|src\/views\/GatherStore\/|src\/views\/Activity\/|src\/views\/IconDoc\/|src\/components\/swipe\/)/,
    loaders: [
        'style',
        cssLoader,
        'postcss',
  ...
  {
    test: /\.(less|css)$/,
    include: /(src\/views\/Home\/|src\/views\/GatherGoods\/|src\/views\/GatherStore\/|src\/views\/Activity\/|src\/views\/IconDoc\/|src\/components\/swipe\/)/,
    exclude: /node_modules/,
    loaders: [
        'style',
        cssModulesLoader,
